...
#### ${\textsf{\color{GreenYellow}{app.py}}}$
...
#### ${\textsf{\color{GreenYellow}{helper-functions.py}}}$
login_required()
...
#### ${\textsf{\color{GreenYellow}{cookie.py}}}$
Cookie()
...
#### ${\textsf{\color{GreenYellow}{customsql.py}}}$
CustomSQL()
...
#### ${\textsf{\color{GreenYellow}{layout.html}}}$
...
#### ${\textsf{\color{GreenYellow}{grid.html}}}$
...
#### ${\textsf{\color{GreenYellow}{index.html}}}$
...
#### ${\textsf{\color{GreenYellow}{product.html}}}$
...
#### ${\textsf{\color{GreenYellow}{favs.html and seasonal.html}}}$
...
#### ${\textsf{\color{GreenYellow}{fullcart.html}}}$
...
#### ${\textsf{\color{GreenYellow}{checkout.html}}}$
...
#### ${\textsf{\color{GreenYellow}{receipt.html}}}$
...
#### ${\textsf{\color{GreenYellow}{script.js}}}$
overlay_off()
...
#### ${\textsf{\color{GreenYellow}{styles.css}}}$
